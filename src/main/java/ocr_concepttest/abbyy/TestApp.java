package ocr_concepttest.abbyy;


import ocr_concepttest.abbyy.com.abbyy.ocrsdk.*;
...
public class TestApp {
	...
	public static void main(String[] args) throws IOException {
		...
		args[1] = "C:\\Users\\Asesoftware\\Desktop\\certicámara\\ocr-test\\images\\hoja de vida.pdf";
		
		//UBICACIÓN RESULTADOS
		args[2] = "C:\\Users\\Asesoftware\\Desktop\\certicámara\\ocr-test\\abbyy\\test2\\hv.txt";
		String pathResults = args[2];
		//args[3] = "--lang=Spanish";
		...
		try {
			...
			timer.finish();			
			ResultsWriter.writeResults(pathResults, null, timer.compare(), false);
